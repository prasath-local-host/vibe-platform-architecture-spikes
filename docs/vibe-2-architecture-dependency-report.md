...
| Check | Result |
| --- | --- |
| Classified production modules | 19 |
| Local dependency edges | 47 |
...
| --- | ---: | --- |
| domain | 1 | `domain.ts` |
| application | 3 | `application-service.ts`, `assessment-service.ts`, `identity.ts` |
...
| composition | `@fastify/helmet`, `@nestjs/common`, `@nestjs/core`, `@nestjs/platform-fastify`, `reflect-metadata` |
